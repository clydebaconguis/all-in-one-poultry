...
class ProductCategoryAdapter(private val context: Context,private val itemList:ArrayList<ProductCategoryModel>): RecyclerView.Adapter<ProductCategoryAdapter.MyViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val view = LayoutInflater.from(context).inflate(R.layout.product_category_item_row, parent, false)
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        if (currentItem.stock < 1 || currentItem.status == 0){
